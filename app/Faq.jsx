...
const Faq = () => {
    ...
    return (
        <div className='py-[64px] h-min w-full relative '>
            <div className='flex flex-col items-center flex-grow-[1] flex-shrink-0 basis-0 gap-16 h-min justify-start max-w-[1640px] p-0 relative'>
                <div className='flex flex-col justify-start flex-shrink-0  flex-none w-full relative h-auto whitespace-pre-wrap '>
                    <h2 className='font-normal text-[#311f40] text-[2.8rem] tracking-tight leading-[1.2rem]  text-center  m-0 p-0'>Your questions <span className='text-[#987de1]'>answered</span></h2>
                </div>
